...
export interface ApiActivitiyLogActivitiyLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'activitiy_logs';
  info: {
    displayName: 'ActivitiyLog';
    pluralName: 'activitiy-logs';
    singularName: 'activitiy-log';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::activitiy-log.activitiy-log'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    activitiy_logs: Schema.Attribute.Relation<
      'oneToMany',
      'api::activitiy-log.activitiy-log'
    >;
    ...
    dailyCalorietake: Schema.Attribute.Integer;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::activitiy-log.activitiy-log': ApiActivitiyLogActivitiyLog;
